defmodule ExClawWeb.SessionsLiveTest do
  ...
  describe "/assistant/sessions/:session_id" do
    ...
    test "renders the requested owned session shell", %{conn: conn, scope: scope} do
      ...
      assert has_element?(view, "#assistant-shell-layout")
      assert has_element?(view, "#assistant-shell-sidebar")
      assert has_element?(view, "#assistant-sidebar-header")
      assert has_element?(view, "#assistant-sidebar-backdrop")
      assert has_element?(view, "#assistant-sidebar-desktop-toggle")
      assert has_element?(view, "#assistant-mobile-sidebar-toggle")
      assert has_element?(view, "#assistant-chat-panel")
      assert has_element?(view, "#assistant-chat-header")
      assert has_element?(view, "#assistant-session-title", session.title)
      assert has_element?(view, "#assistant-sidebar-header h2", "Sessions")
